...
plausible guess. This is how you find out which guesses were wrong, before a
silent empty feed costs you a week of missing events.

    # on the server (the api image contains this module):
...
from ..market.service import build_provider
...
def run(
    *,
    ...
    """Probe everything and print a report. Returns the intended exit status."""
    args = _Args(
        sources=sources,
